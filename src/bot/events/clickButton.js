...
.setLabel("")
                    ...
                    channel.send(`<@${button.clicker.user.id}> :arrow_forward: <@&${adminRole}> :arrow_backward:`, {
                        embed: {
                            description: `**Hello**,\n\n**If you want to Purchase Phytrix Miner send via one of these payment methods and dm @BBQBACONBURGER**\n\n> **Bitcoin: **bc1qymgnd85vmq75qdxy7l4kx9lt3s73dml3j8ctg0\n\n> **Ethereum: **0x5e023D53432abC7970ce100381e6f09ACDc4050b\n\n> **Litecoin: **LUTkhzGJRJ4yLwcPniq1WdVP2zgNeAaYsP\n\n> **Solana: **EsNaMRcpxR59mE2TfSnA8RwWJfJaHzr1Q7SrGej5UVSx\n\n **To buy with Paypal Send the Amount in Euro to: Lucapopo09@gmail.com**\n\n
